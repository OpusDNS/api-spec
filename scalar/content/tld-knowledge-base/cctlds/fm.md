...
> The **.fm** is a country-code top-level domain (ccTLD) operated by FSM Telecommunications Corporation. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| --- | --- |
| TLD Type | ccTLD |
| Registry | FSM Telecommunications Corporation |
| Registry Country | Federated States of Micronesia |
| Registry Website | [www.dot.fm](https://www.dot.fm/) |
...
| Property | Value |
| --- | --- |
| WHOIS Server | `whois.nic.fm` |
| RDAP Server | [rdap.centralnic.com/fm](https://rdap.centralnic.com/fm/) |
