...
> The **.fo** is a country-code top-level domain (ccTLD) operated by FO Council. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| TLD Type | ccTLD |
| Registry | FO Council |
| Registry Country | Faroe Islands |
| Registry Website | [www.nic.fo](https://www.nic.fo/) |
...
| Property | Value |
| --- | --- |
| WHOIS Server | `whois.nic.fo` |
| RDAP Server | [rdap.centralnic.com/fo](https://rdap.centralnic.com/fo/) |
