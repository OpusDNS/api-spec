...
> The **.gd** is a country-code top-level domain (ccTLD) operated by The National Telecommunications Regulatory Commission (NTRC). This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| --- | --- |
| TLD Type | ccTLD |
| Registry | The National Telecommunications Regulatory Commission (NTRC) |
| Registry Country | Grenada |
| Registry Website | [nic.gd](https://nic.gd/) |
...
| Property | Value |
| --- | --- |
| WHOIS Server | `whois.nic.gd` |
| RDAP Server | [rdap.centralnic.com/gd](https://rdap.centralnic.com/gd/) |
