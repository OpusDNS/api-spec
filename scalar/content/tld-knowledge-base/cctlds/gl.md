...
> The **.gl** is a country-code top-level domain (ccTLD) operated by TELE Greenland A/S. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| Registry Country | Greenland |
| Registry Website | [www.nic.gl](https://www.nic.gl/) |
