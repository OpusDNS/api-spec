...
> The **.je** is a country-code top-level domain (ccTLD) operated by Island Networks (Jersey) Ltd.. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| --- | --- |
| TLD Type | ccTLD |
| Registry | Island Networks (Jersey) Ltd. |
| Registry Country | Jersey |
