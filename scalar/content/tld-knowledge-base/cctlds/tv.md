...
> The **.tv** is a country-code top-level domain (ccTLD) operated by Ministry of Transport, Energy, Communications and Innovations. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| --- | --- |
| TLD Type | ccTLD |
| Registry | Ministry of Transport, Energy, Communications and Innovations |
| Registry Country | Tuvalu |
| Registry Website | [turnon.tv](https://turnon.tv) |
