...
> The **.vu** is a country-code top-level domain (ccTLD) operated by Telecommunications Radiocommunications and Broadcasting Regulator (TRBR). This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| --- | --- |
| TLD Type | ccTLD |
| Registry | Telecommunications Radiocommunications and Broadcasting Regulator (TRBR) |
| Registry Country | Vanuatu |
| Registry Website | [vunic.vu](https://vunic.vu) |
...
| RDAP Server | [rdap.godaddy.com](https://rdap.godaddy.com) |
