...
> The **.bayern** is a generic top-level domain (gTLD) operated by Bayern Connect GmbH. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| Registry Website | [domains.bayern](https://domains.bayern) |
...
| RDAP Server | [rdap.nic.bayern](https://rdap.nic.bayern/) |
