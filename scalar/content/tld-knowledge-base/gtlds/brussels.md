# 🌐 .brussels — DNS Belgium

> The **.brussels** is a generic top-level domain (gTLD) operated by DNS Belgium. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| Property | Value |
| --- | --- |
| RDAP Server | [rdap.nic.brussels](https://rdap.nic.brussels/) |
