...
> The **.hamburg** is a generic top-level domain (gTLD) operated by TLD-BOX Registrydienstleistungen GmbH. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| RDAP Server | [rdap.nic.hamburg/v1](https://rdap.nic.hamburg/v1/) |
