# 🌐 .mobile — Tucows Registry Inc.

> The **.mobile** is a generic top-level domain (gTLD) operated by Tucows Registry Inc.. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| Property | Value |
| --- | --- |
| WHOIS Server | `whois.nic.mobile` |
| RDAP Server | [rdap.mobile-registry.com/rdap](https://rdap.mobile-registry.com/rdap) |
