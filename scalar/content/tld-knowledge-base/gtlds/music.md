# 🌐 .music — Tucows Registry Inc.

> The **.music** is a generic top-level domain (gTLD) operated by Tucows Registry Inc.. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| --- | --- |
| TLD Type | gTLD |
| Registry | Tucows Registry Inc. |
| Registry Country | Canada |
| Registry Website | [www.tucowsregistry.com](https://www.tucowsregistry.com) |
...
| Auto-Renewal Before Expiry | 1 day before expiration |
...
| Property | Value |
| --- | --- |
| WHOIS Server | `whois.nic.music` |
| RDAP Server | [rdap.registryservices.music/rdap](https://rdap.registryservices.music/rdap) |
