...
> The **.name** is a generic top-level domain (gTLD) operated by VeriSign, Inc.. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| RDAP Server | [tld-rdap.verisign.com/name/v1](https://tld-rdap.verisign.com/name/v1/) |
