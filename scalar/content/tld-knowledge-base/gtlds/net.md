...
> The **.net** is a generic top-level domain (gTLD) operated by VeriSign, Inc.. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| RDAP Server | [rdap.verisign.com/net/v1](https://rdap.verisign.com/net/v1/) |
