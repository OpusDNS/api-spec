...
> The **.nrw** is a generic top-level domain (gTLD) operated by Minds + Machines GmbH. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| Registry Website | [domains.nrw](https://domains.nrw) |
...
| AuthInfo Required | ✅ Yes (4–89 characters) |

## Nameservers & DNS

| Property | Value |
| --- | --- |
| Nameserver Count | 0–12 |
...
| Property | Value |
| --- | --- |
| WHOIS Server | `whois.nic.nrw` |
| RDAP Server | [rdap.nic.nrw](https://rdap.nic.nrw/) |
