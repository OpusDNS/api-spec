...
> The **.tirol** is a generic top-level domain (gTLD) operated by punkt Tirol GmbH. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| Registry Website | [www.nic.tirol](https://www.nic.tirol) |
...
| Property | Value |
| --- | --- |
| WHOIS Server | `whois.nic.tirol` |
| RDAP Server | [rdap.ryce-rsp.com/rdap](https://rdap.ryce-rsp.com/rdap/) |
