# 🌐 .website — Tucows Registry Inc.

> The **.website** is a generic top-level domain (gTLD) operated by Tucows Registry Inc.. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| Property | Value |
| --- | --- |
| WHOIS Server | `whois.radix.host` |
| RDAP Server | [rdap.radix.host/rdap](https://rdap.radix.host/rdap) |
