...
> The **.xn--i1b6b1a6a2e** is a generic top-level domain (gTLD) operated by Public Interest Registry. This article documents the technical, operational, and contractual requirements for the TLD, along with special considerations for registry, registrar, and domain management.
...
| Property | Value |
| --- | --- |
| WHOIS Server | `whois.nic.xn--i1b6b1a6a2e` |
