...
export const REGISTRY_HANDLE_ATTRIBUTE_TYPE = {
  ...
  REGISTRY_SE_ORG_NO: "REGISTRY_SE_ORG_NO",
  REGISTRY_SE_VAT_NO: "REGISTRY_SE_VAT_NO",
  DNS_PT_VAT: "DNS_PT_VAT",
  DNS_PT_MOBILE: "DNS_PT_MOBILE",
  DNS_PT_NIS2_VALIDATED: "DNS_PT_NIS2_VALIDATED",
  DNS_PT_NIS2_VALIDATED_DATE: "DNS_PT_NIS2_VALIDATED_DATE",
  PUNKTUM_DK_USER_TYPE: "PUNKTUM_DK_USER_TYPE",
  PUNKTUM_DK_CVR: "PUNKTUM_DK_CVR",
  PUNKTUM_DK_PNUMBER: "PUNKTUM_DK_PNUMBER",
  PUNKTUM_DK_EAN: "PUNKTUM_DK_EAN",
  PUNKTUM_DK_SECONDARY_EMAIL: "PUNKTUM_DK_SECONDARY_EMAIL",
  PUNKTUM_DK_MOBILEPHONE: "PUNKTUM_DK_MOBILEPHONE",
  PUNKTUM_DK_SOLE_PROPRIETORSHIP: "PUNKTUM_DK_SOLE_PROPRIETORSHIP",
  PUNKTUM_DK_CONTACT_VERIFIED: "PUNKTUM_DK_CONTACT_VERIFIED",
  INTERNET_EE_IDENT_TYPE: "INTERNET_EE_IDENT_TYPE",
  INTERNET_EE_IDENT_CC: "INTERNET_EE_IDENT_CC",
  INTERNET_EE_IDENT_VALUE: "INTERNET_EE_IDENT_VALUE",
...
export const REGISTRY_HANDLE_ATTRIBUTE_TYPE_VALUES = [
  ...
  'DNS_PT_VAT',
  'DNS_PT_MOBILE',
  'DNS_PT_NIS2_VALIDATED',
  'DNS_PT_NIS2_VALIDATED_DATE',
