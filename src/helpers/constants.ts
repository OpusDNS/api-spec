...
export const PERMISSION = {
  ...
  VIEW_REGISTRAR_CREDENTIALS: "view_registrar_credentials",
  VIEW_TAGS: "view_tags",
...
export const RELATION = {
  ...
  DNS_ZONE_VIEW: "dns_zone_view",
  DNS_ZONE_MANAGE: "dns_zone_manage",
  DNS_ZONE_DELETE: "dns_zone_delete",
  HOST_VIEW: "host_view",
  HOST_MANAGE: "host_manage",
  HOST_DELETE: "host_delete",
  EMAIL_FORWARD_VIEW: "email_forward_view",
  EMAIL_FORWARD_MANAGE: "email_forward_manage",
  EMAIL_FORWARD_DELETE: "email_forward_delete",
  DOMAIN_FORWARD_VIEW: "domain_forward_view",
  DOMAIN_FORWARD_MANAGE: "domain_forward_manage",
  ...
  REGISTRAR_CREDENTIAL_VIEW: "registrar_credential_view",
  REGISTRAR_CREDENTIAL_MANAGE: "registrar_credential_manage",
  REGISTRAR_CREDENTIAL_DELETE: "registrar_credential_delete",
  USER_VIEW: "user_view",
